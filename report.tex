...
Edo will be an online platform and thus the users are required to use the browser and enter the URL or Edo to access \thispagestyle{?}s system. The physical machine could be either PC or tablets.
