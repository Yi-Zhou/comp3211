...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item The professor enters his/her personal homepage, and clicks on a course he teaches.
	\end{enumerate}
	\par Professor create assignment
	\begin{enumerate}
		\item The professor clicks the create content button, and chooses one file from his/her PC to upload.
		...
		\item The professor clicks the assignment submission button to view all assignment submissions, and marks those submissions by entering the grades in the grade bar.
	\end{enumerate}
	\par Professor create quiz
	\begin{enumerate}
		\item The professor clicks create quiz.
		\item The professor enters the title of the quiz.
	...
	\begin{figure}[!ht]
		...
		\end{center}
		\caption{Use case diagram of Edo}
	\end{figure}
