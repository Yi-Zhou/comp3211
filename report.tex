...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{data_model}
	\end{center}
...
See Figure \ref{stud} for sequence diagram for students and \ref{prof} for sequence diagram for professors.
\begin{figure}[!ht]
	\begin{center}
